...
import { groupedDestinations, groupedOrigins, searchFlights } from '../lib/connect/engine'
    ...
    <div className="modal-back" onClick={onClose} role="presentation">
      ...
      >
        ...
        <p className="muted" style={{ margin: '6px 0 14px' }}>
          인천·김포에서 중국·홍콩·마카오·대만으로 가는 편만 찾습니다. 인천은 공항 출발 시간표를 가져오고, 운임은 시범 값입니다.
        </p>
        ...
        {out ? <ResultList title="출발 시간표" offers={out} onPick={onPick} /> : null}
...
function ResultList({
  ...
  return (
    <div className="result-block">
      ...
      {offers.length === 0 ? (
        <p className="muted">이 날짜·목적지에 출발 편이 없습니다. 다른 공항을 고르거나 직접 입력해 주세요.</p>
      ) : (
