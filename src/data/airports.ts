...
export const DEST_AIRPORTS: Airport[] = [
  ...
  { code: 'PKX', city: '北京', name: '다싱', country: '중국' },
  { code: 'PEK', city: '北京', name: '서우두', country: '중국' },
  { code: 'PVG', city: '上海', name: '푸동', country: '중국' },
  { code: 'SHA', city: '上海', name: '훙차오', country: '중국' },
  ...
  { code: 'XIY', city: '西安', name: '셴양', country: '중국' },
  ...
  { code: 'DYG', city: '张家界', name: '허화', country: '중국' },
  ...
  { code: 'TFU', city: '成都', name: '톈푸', country: '중국' },
  ...
  { code: 'HKG', city: '香港', name: '홍콩', country: '홍콩' },
