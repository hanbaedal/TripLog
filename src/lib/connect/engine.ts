...
const HOTELS: HotelTemplate[] = [
  ...
  { name: '더 페닌슐라 베이징', city: '北京', area: '왕푸징', stars: 5, nightly: 380000, rating: 9.0, amenities: ['중심가', '스파'] },
  { name: '오포짓 하우스 싼리툰', city: '北京', area: '싼리툰', stars: 4, nightly: 210000, rating: 8.4, amenities: ['나이트라이프'] },
  { name: '더 페닌슐라 상하이', city: '上海', area: '외탄', stars: 5, nightly: 420000, rating: 9.2, amenities: ['외탄', '강뷰'] },
  { name: '진장 메트로폴로 상하이', city: '上海', area: '인민광장', stars: 4, nightly: 198000, rating: 8.3, amenities: ['지하철'] },
