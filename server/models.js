...
const travelSpotSchema = new mongoose.Schema(
  {
    ...
    subwayLine: { type: String, default: '', trim: true },
    subwayStation: { type: String, default: '', trim: true },
    subwayRegion: { type: String, default: '', trim: true },
    subwayExit: { type: String, default: '', trim: true },
    walkMin: { type: Number, default: null },
    photoId: { type: String, default: '', trim: true },
    src: { type: String, default: '' },
    sort: { type: Number, default: 80 },
    catalog: { type: Boolean, default: false },
